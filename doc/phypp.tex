...
This function will return \cppinline{true} if this vector contains at least one element, and \cppinline{false} otherwise. In particular, \cppinline{true} will be returned for default constructed vectors, and after a call to \cppinline{vec::clear()}.
...
\subsection{ASCII table input/output}
