...
In the following examples, we will parse a table
\begin{cppcode}
    // File extension does not matter
    std::string table = "some/ascii_table.dat";
\end{cppcode}
...
We can use this function to create an ASCII table:
\begin{cppcode}
